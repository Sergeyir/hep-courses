 ...
 *
 *  This file is a part of a project hep-courses/jets_advanced (https://github.com/Sergeyir/hep-courses/jets_advanced).
 *
...
int main(int argc, char **argv)
{
   ...
   // To do: read and assign below the collision energy, pdf set, and R from the .yaml file
